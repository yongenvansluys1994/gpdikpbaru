...
class jadwalCard_pelprip extends StatefulWidget {
  String kategori;
  jadwalCard_pelprip({super.key, required this.kategori});

  @override
  State<jadwalCard_pelprip> createState() => _jadwalCard_pelpripState();
}

class _jadwalCard_pelpripState extends State<jadwalCard_pelprip> {
  themedark theme = Get.find();
  @override
  void initState() {
    super.initState();
    // TODO: implement initState
    Get.find<Jadwal_Controller_pelprip>()
        .loadGetJadwal(kategori: widget.kategori);
  }

  @override
  Widget build(BuildContext context) {
    return GetBuilder<Jadwal_Controller_pelprip>(builder: (jadwal_C) {
      return Obx(
        () {
