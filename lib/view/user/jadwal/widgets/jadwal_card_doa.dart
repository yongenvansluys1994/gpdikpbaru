...
class jadwalCard_doa extends StatefulWidget {
  String kategori;
  jadwalCard_doa({super.key, required this.kategori});

  @override
  State<jadwalCard_doa> createState() => _jadwalCard_doaState();
}

class _jadwalCard_doaState extends State<jadwalCard_doa> {
  themedark theme = Get.find();
  @override
  void initState() {
    super.initState();
    // TODO: implement initState
    Get.find<Jadwal_Controller_doa>()
        .loadGetJadwal_doa(kategori: widget.kategori);
  }

  @override
  Widget build(BuildContext context) {
    return GetBuilder<Jadwal_Controller_doa>(builder: (jadwal_C) {
      return Obx(
        () {
          ...
          return ListView.builder(
              ...
              itemBuilder: (context, index) {
                var datajadwal = jadwal_C.dataJadwal_doa[
                    index]; // here is your wordItem ready to be used
                var modeljadwal = jadwal_C.item_doa(index);
                return Stack(
                  children: [
                    Container(
                      decoration: BoxDecoration(
