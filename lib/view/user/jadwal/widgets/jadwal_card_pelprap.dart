...
class jadwalCard_pelprap extends StatefulWidget {
  String kategori;
  jadwalCard_pelprap({super.key, required this.kategori});

  @override
  State<jadwalCard_pelprap> createState() => _jadwalCard_pelprapState();
}

class _jadwalCard_pelprapState extends State<jadwalCard_pelprap> {
  themedark theme = Get.find();
  @override
  void initState() {
    super.initState();
    // TODO: implement initState
    Get.find<Jadwal_Controller_pelprap>()
        .loadGetJadwal(kategori: widget.kategori);
  }

  @override
  Widget build(BuildContext context) {
    return GetBuilder<Jadwal_Controller_pelprap>(builder: (jadwal_C) {
      return Obx(
        () {
