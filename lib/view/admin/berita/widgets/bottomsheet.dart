...
tambahberita_bottom(
  ...
  final inputBeritaController berita_C = Get.find();
  Get.bottomSheet(
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          child: TextFormField(
                            controller: berita_C.judul_renunganCon,
                        ...
                        Container(
                          child: TextFormField(
                            controller: berita_C.isi_renunganCon,
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            GestureDetector(
                                onTap: () => {berita_C.PilihPicker()},
                                child: GetBuilder<inputBeritaController>(
                                  // specify type as Controller
                                  init:
                                      inputBeritaController(), // intialize with the Controller
                                  builder: (value) => Container(
                                      width: 110,
                                      height: 90,
                                      child: (berita_C.image_url != "")
                                          ? Image.network(
                                              berita_C.image_url.value)
                                          : (berita_C.image == null)
                                              ? Image.asset(
                                                  "assets/images/default-img.png")
                                              : Image.file(
                                                  File(berita_C.pathImage))),
                                )),
                          ],
                        ),
                      ],
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: OutlinedButton.icon(
                            ...
                            onPressed: () {
                              berita_C.CheckInput(aksi: aksi, id_renungan: Id);
                            },
