...
import 'package:gpdikpbaru/view/admin/contactperson/contactperson_item.dart';
...
class contactpersonAdmin extends StatelessWidget {
  var selectedfABLocation = FloatingActionButtonLocation.endDocked;
  final home_controller2 session_C = Get.find();
  final ContactPerson_Controller controller = Get.find();

  contactpersonAdmin({super.key});
    ...
    return Stack(
      children: [
        Scaffold(
          ...
          appBar: CustomAppBar(title: "Contact Person", leading: true),
                    ...
                    () {
                      ...
                      return ScrollablePositionedList.builder(
                        ...
                        itemBuilder: (_, index) {
                          ...
                          // User Item
                          if (isItem)
                            return ContactPersonItem(controller.item(index));
          ...
          floatingActionButton: SpeedDial(
            ...
            onPress: () {
              tambah_bottom(aksi: "input", Id: 0, context: context);
            },
          ),
