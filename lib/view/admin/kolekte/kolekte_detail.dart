...
class KolekteDetail extends StatefulWidget {
  final ModelPersembahan dataPersembahan;

  KolekteDetail({super.key, required this.dataPersembahan});

  @override
  State<KolekteDetail> createState() => _KolekteDetailState();
}

class _KolekteDetailState extends State<KolekteDetail> {
