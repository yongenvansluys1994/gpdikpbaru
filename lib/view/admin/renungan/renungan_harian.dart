...
import 'package:gpdikpbaru/view/admin/renungan/renungan_item.dart';
import 'package:gpdikpbaru/view/admin/renungan/widgets/bottomsheet.dart';
...
class renunganAdmin extends StatelessWidget {
  ...
  final Renungan_Controller controller = Get.find();

  renunganAdmin({super.key});
      ...
      children: [
        Scaffold(
                    ...
                    () {
                      ...
                      return ScrollablePositionedList.builder(
                        ...
                        itemBuilder: (_, index) {
                          ...
                          // User Item
                          if (isItem)
                            return RenunganItem(controller.item(index));
          ...
          floatingActionButton: SpeedDial(
            ...
            onPress: () {
              tambahrenungan_bottom(aksi: "input", Id: "", context: context);
            },
          ),
