...
import 'package:gpdikpbaru/view/admin/renungan/renungan_detail.dart';
import 'package:gpdikpbaru/view/admin/renungan/widgets/bottomsheet.dart';

import 'package:sizer/sizer.dart';

class RenunganItem extends StatelessWidget {
  final ModeldataRenungan user;
  final inputRenunganController controller = Get.put(inputRenunganController());
    ...
    return InkWell(
      onTap: () {
        Get.toNamed(GetRoutes.renungandetail,
            arguments: RenunganDetail(detail: user));
      },
      child: Column(
        children: [
          Slidable(
